...
var baseUrl="https://livedemo.espressologic.com/rest/demo/Demo_T3lci/v1/";

// The API key use to access the demo project
var currentApiKey = "diARDrTZioN7amV";
...
function highlightChanges() {
	...
	for (var j = 0; j < allChanges.length; j++) {
		...
		(function(){
			var id = "#" + allChanges[j];
			tooltipHide.push(setTimeout(function() {
